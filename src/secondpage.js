   ...
   const ScissorsButton = () => {
      return (
          <div className='game-button scissors-section'>
              <div className=' icon-bg scissors'>
                  <img src='../images/icon-scissors.svg' className="rgba-white-strong"></img>
              </div>
          </div>
      )
  }
    return(
        ...
        <div className='Game--play'>
            ...
            <div className='container game-play-main row'>
                <div className='User--choice col-5'>
                    <h2 className='youpicked'>YOU PICKED</h2>
                    <div className='User'>
                ...
                <div className='result col-2'>
                    <h1> {result}</h1>
                    <button onClick={() => { navigate('/');  }} className='playagain'>Play again</button>
            </div>
                <div className='computer--choice col-5'>
                    <h2 className='housepicked'> HOUSE PICKED</h2>
                    <div className='house'>                    
